...
<div id="wrap">
   ...
   <ul id="nav">
	...
	<h1 style="color:red;font-size:120%;text-indent:250px; font-weight: regular;">SERVICES</h1>
	
	<div id='con-box-left'>
	<div id="divLine-left">
	</br>
	<p style="margin-top:20px;margin-left:10px;color:#485551;font-size:95%;width:500px;">Every application comes with its own set of requirements and challenges. By offering a comprehensive collection of heat transfer technologies, BECAP Heat Transfer can select the product design that best fits your requirements, without forcing a solution due to limited product scope.<p>
	</div>
	<div id="divLine-left">
